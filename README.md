...
### 🚀 About Me
[cite_start]I am **Lee Valencio RABARISON**, a 3rd-year Management Information Systems student at **IS-INFO Ampasamadinika**[cite: 1, 11, 12]. [cite_start]I am a motivated developer specialized in web development (front-end & back-end) with a strong foundation in database design[cite: 2].

- [cite_start]🎯 **Goal**: Secure a graduation internship to finalize my Bachelor's degree[cite: 11].
- [cite_start]🌍 **Languages**: Native Speaker, French (DELF B2), and English (Intermediate)[cite: 66, 67, 68].
- [cite_start]⚡ **Personal**: Analytical, organized, and a fast learner[cite: 3, 61].
